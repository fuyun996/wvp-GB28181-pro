<template>
  <div id="app" style="width: 100%">
        ...
        <el-table :data="recordList" style="width: 100%" :height="winHeight">
          ...
          <el-table-column label="操作" width="360" fixed="right">
            <template slot-scope="scope">
              <el-button size="medium" icon="el-icon-folder-opened" type="text"
                @click="showRecordDetail(scope.row)">查看</el-button>
    ...
    <cloud-record-detail ref="cloudRecordDetail" v-if="recordDetail" :recordFile="chooseRecord"
      :mediaServerId="mediaServerId" :mediaServerPath="mediaServerPath"></cloud-record-detail>
